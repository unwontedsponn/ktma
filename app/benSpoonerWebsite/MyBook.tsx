      ...
      <section id="myBook" className="pt-[var(--header-height)] pb-[var(--footer-height)] flex flex-col w-full h-screen overflow-hidden">
        ...
        <div className="flex flex-row justify-center gap-x-8 px-32 items-center h-screen overflow-hidden">
          ...
          <div className="flex flex-col">       
            ...
            <SlideFadeIn direction="right" className="color-dark-blue font-gopher-mono underline text-decoration-color tracking-largep text-2xl md:pl-32"><p>in 14 days</p></SlideFadeIn>
