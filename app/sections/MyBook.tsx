...
const MyBook: React.FC = () => {    
  ...
  return (
    <section id="myBook" className="pt-[var(--header-height)] pb-[var(--footer-height)] flex flex-col w-full md:h-screen">
      ...
      <div className={`flex flex-col md:flex-row justify-center items-center gap-x-8 px-4 md:px-0 items-center h-auto md:h-screen ${isNarrowViewport ? 'space-y-8' : 'overflow-hidden'}`}>
        ...
        {!isNarrowViewport ? (
          <>
            ...
            <div className="flex flex-col justify-center items-center md:hidden h-full space-y-4 px-4 sm:px-8 text-center">
              {/* Section Title */}
              <SlideFadeIn direction="left" className="text-5xl sm:text-6xl font-gopher-mono-semi color-blue mb-2">
                <h1 className="opacity-40">myBook</h1>
              </SlideFadeIn>
